...
pub extern "proposal_symmetric" fn symmetricKeyGenerate(
...
pub extern "proposal_symmetric" fn symmetricKeyImport(
    algorithm_ptr: WasiMutPtr(Char8),
    algorithm_len: usize,
    raw: WasiPtr(u8),
    raw_len: Size,
...
pub extern "proposal_symmetric" fn symmetricKeyExport(
...
pub extern "proposal_symmetric" fn symmetricKeyClose(
    symmetric_key: SymmetricKey,
) callconv(.C) CryptoErrno;
...
pub extern "proposal_symmetric" fn symmetricKeyGenerateManaged(
...
pub extern "proposal_symmetric" fn symmetricKeyStoreManaged(
    secrets_manager: SecretsManager,
    symmetric_key: SymmetricKey,
...
pub extern "proposal_symmetric" fn symmetricKeyReplaceManaged(
    secrets_manager: SecretsManager,
...
/// 
/// This is an optional import, meaning that the function may not even exist.
pub extern "proposal_symmetric" fn symmetricKeyId(
    symmetric_key: SymmetricKey,
    symmetric_key_id: WasiMutPtr(u8),
    symmetric_key_id_max_len: Size,
...
/// 
/// This is an optional import, meaning that the function may not even exist.
pub extern "proposal_symmetric" fn symmetricKeyFromId(
    secrets_manager: SecretsManager,
...
/// // ...
/// ```
pub extern "proposal_symmetric" fn symmetricStateOpen(
    algorithm_ptr: WasiMutPtr(Char8),
    algorithm_len: usize,
    key: OptSymmetricKey,
    options: OptOptions,
...
pub extern "proposal_symmetric" fn symmetricStateOptionsGet(
...
/// 
/// It may also return `unsupported_option` if the option doesn't exist for the chosen algorithm.
pub extern "proposal_symmetric" fn symmetricStateOptionsGetU64(
    handle: SymmetricState,
    name_ptr: WasiMutPtr(Char8),
    name_len: usize,
...
/// 
/// Objects are reference counted. It is safe to close an object immediately after the last function needing it is called.
pub extern "proposal_symmetric" fn symmetricStateClose(
    handle: SymmetricState,
) callconv(.C) CryptoErrno;
...
pub extern "proposal_symmetric" fn symmetricStateAbsorb(
    handle: SymmetricState,
    data: WasiPtr(u8),
    data_len: Size,
) callconv(.C) CryptoErrno;
...
pub extern "proposal_symmetric" fn symmetricStateSqueeze(
    handle: SymmetricState,
    out: WasiMutPtr(u8),
    out_len: Size,
) callconv(.C) CryptoErrno;
...
/// For password-stretching functions, the function may return `in_progress`.
/// In that case, the guest should retry with the same parameters until the function completes.
pub extern "proposal_symmetric" fn symmetricStateSqueezeTag(
    handle: SymmetricState,
...
pub extern "proposal_symmetric" fn symmetricStateSqueezeKey(
    handle: SymmetricState,
...
pub extern "proposal_symmetric" fn symmetricStateMaxTagLen(
    handle: SymmetricState,
    result_ptr: WasiMutPtr(Size),
) callconv(.C) CryptoErrno;
...
pub extern "proposal_symmetric" fn symmetricStateEncrypt(
    handle: SymmetricState,
    out: WasiMutPtr(u8),
    out_len: Size,
    data: WasiPtr(u8),
...
/// 
/// `invalid_operation` is returned for algorithms not supporting encryption.
pub extern "proposal_symmetric" fn symmetricStateEncryptDetached(
    handle: SymmetricState,
    out: WasiMutPtr(u8),
    out_len: Size,
    data: WasiPtr(u8),
...
/// 
/// `invalid_operation` is returned for algorithms not supporting encryption.
pub extern "proposal_symmetric" fn symmetricStateDecrypt(
    handle: SymmetricState,
    out: WasiMutPtr(u8),
    out_len: Size,
    data: WasiPtr(u8),
...
/// 
/// `invalid_operation` is returned for algorithms not supporting encryption.
pub extern "proposal_symmetric" fn symmetricStateDecryptDetached(
    handle: SymmetricState,
    out: WasiMutPtr(u8),
    out_len: Size,
    data: WasiPtr(u8),
...
pub extern "proposal_symmetric" fn symmetricStateRatchet(
    handle: SymmetricState,
) callconv(.C) CryptoErrno;
...
pub extern "proposal_symmetric" fn symmetricTagLen(
...
pub extern "proposal_symmetric" fn symmetricTagPull(
    symmetric_tag: SymmetricTag,
    buf: WasiMutPtr(u8),
    buf_len: Size,
    result_ptr: WasiMutPtr(Size),
...
/// ctx.symmetric_tag_verify(computed_tag_handle, expected_raw_tag)?;
/// ```
pub extern "proposal_symmetric" fn symmetricTagVerify(
    symmetric_tag: SymmetricTag,
...
/// 
/// Objects are reference counted. It is safe to close an object immediately after the last function needing it is called.
pub extern "proposal_symmetric" fn symmetricTagClose(
    symmetric_tag: SymmetricTag,
) callconv(.C) CryptoErrno;
